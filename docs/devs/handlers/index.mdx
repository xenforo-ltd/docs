...
## How handlers work {/* #how-handlers-work */}
...
Content type fields are managed through the Admin control panel at **Development > Execution manipulation > Content types**. This area is only available when [development mode](../development-tools.mdx#enabling-development-mode) is enabled.
...
See [Entities, finders and repositories](../entities-finders-repositories.mdx#content-type) for more details.
:::

### How handlers are discovered {/* #how-handlers-are-discovered */}
...
## Common handler systems {/* #common-handler-systems */}
