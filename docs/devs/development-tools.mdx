...
## Preventing frequent logout for users with a dynamic IP {/* #preventing-frequent-logout-for-users-with-a-dynamic-ip */}
...
## Add-on specific commands {/* #add-on-specific-commands */}
...
### Export \_data .XML files {/* #export-_data-xml-files */}
...
### Bump your add-on version {/* #bump-your-add-on-version */}
...
### Validate your addon.json file {/* #validate-your-addonjson-file */}
...
### Run a specific Setup step {/* #run-a-specific-setup-step */}
...
#### Run an install step {/* #run-an-install-step */}

```sh title="Terminal"
php cmd.php xf-addon:install-step [addon_id] [step]
```

#### Run an upgrade step {/* #run-an-upgrade-step */}

```sh title="Terminal"
php cmd.php xf-addon:upgrade-step [addon_id] [version] [step]
```

#### Run an uninstall step {/* #run-an-uninstall-step */}

```sh title="Terminal"
php cmd.php xf-addon:uninstall-step [addon_id] [step]
```

## Building an add-on release {/* #building-an-add-on-release */}
...
### Import development output {/* #import-development-output */}
...
### Export development output {/* #export-development-output */}
...
### Dump a variable {/* #dump-a-variable */}
