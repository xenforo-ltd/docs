...
![Screenshot: macOS running XenForo, being debugged by Xdebug with Visual Studio Code](/img/docs/macos-debugging.jpg)
...
![Screenshot: Three versions of PHP running concurrently through the Apache webserver](/img/docs/macos-php-versions.png)
...
![Screenshot: XenForo admin control panel reporting MySQL installed instead of MariaDB](/img/docs/server-report.png)
