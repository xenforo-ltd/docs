...
## Installing Homebrew packages {/* #installing-homebrew-packages */}
...
### PHP, Apache, MariaDB, ElasticSearch, Mailhog, ImageMagick {/* #php-apache-mariadb-elasticsearch-mailhog-imagemagick */}
...
### Multiple PHP versions with Xdebug and ImageMagick {/* #multiple-php-versions-with-xdebug-and-imagemagick */}
...
#### Xdebug and Mailhog {/* #xdebug-and-mailhog */}
...
##### `/usr/local/etc/php/5.6/conf.d/php-dev.ini` {/* #usrlocaletcphp56confdphp-devini */}
...
##### `/usr/local/etc/php/7.4/conf.d/php-dev.ini` **and** `/usr/local/etc/php/8.0/conf.d/php-dev.ini` {/* #usrlocaletcphp74confdphp-devini-and-usrlocaletcphp80confdphp-devini */}
...
#### Fast CGI (php-fpm) {/* #fast-cgi-php-fpm */}
...
## Selecting a PHP version {/* #selecting-a-php-version */}
...
### .htaccess for PHP 5.6 {/* #htaccess-for-php-56 */}
...
### .htaccess for PHP 7.4 {/* #htaccess-for-php-74 */}
...
### .htaccess for PHP 8.0 {/* #htaccess-for-php-80 */}
...
## IDE, debugging and DB manager {/* #ide-debugging-and-db-manager */}
...
Check out our section on [Visual Studio Code and how to use it with Xdebug](vscode.mdx).
...
### Terminal command summary {/* #terminal-command-summary */}
...
#### Make the following edits {/* #make-the-following-edits */}
...
### PHP-version-targeting .htaccess files {/* #php-version-targeting-htaccess-files */}
...
## Note for CJK users {/* #note-for-cjk-users */}
...
## Build imagick manually {/* #build-imagick-manually */}
