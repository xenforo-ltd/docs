...
![Screenshot: Ubuntu Linux running XenForo, being debugged by Xdebug with Visual Studio Code](/img/docs/linux-debugging.jpg)
...
![Screenshot: Three versions of PHP running concurrently through the Apache webserver](/img/docs/linux-php-versions.png)
