...
### (Optionally) Storing selected criteria {/* #optionally-storing-selected-criteria */}
...
## How criteria works (example) {/* #how-criteria-works-example */}
...
## Extra criteria data {/* #extra-criteria-data */}
...
### Adding data in custom criteria type {/* #adding-data-in-custom-criteria-type */}
...
### Adding data to existing criteria types {/* #adding-data-to-existing-criteria-types */}
...
## "helper_criteria" template {/* #helper_criteria-template */}
...
#### Including without tabs {/* #including-without-tabs */}
...
### Adding custom criteria type to "helper_criteria" {/* #adding-custom-criteria-type-to-helper_criteria */}
...
### Adding template modification {/* #adding-template-modification */}
...
:::warning
If there is no "Admin" tab make sure you have enabled the [development mode](development-tools.mdx#enabling-development-mode)!
...
### Adding code event listener {/* #adding-code-event-listener */}
...
### Handling criterion {/* #handling-criterion */}
...
## Custom criteria type example {/* #custom-criteria-type-example */}
...
### Criteria type class {/* #criteria-type-class */}
...
### Matching the criteria {/* #matching-the-criteria */}
