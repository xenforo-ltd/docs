...
You can read more about controllers in the [Controller basics](controller-basics.mdx) section.

## A more advanced example (route formats) {/* #a-more-advanced-example-route-formats */}
