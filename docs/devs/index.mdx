...
## XenForo system requirements {/* #xenforo-system-requirements */}
...
* [macOS Dev Environment](appendix/macos-dev.mdx)
* [Linux Dev Environment](appendix/linux-dev.mdx)
* [Windows Dev Environment](appendix/windows-dev.mdx)

### Pre-built stack {/* #pre-built-stack */}
...
## A note on file permissions {/* #a-note-on-file-permissions */}
...
If you have been developing add-ons, and you have chosen to keep or backup your existing `src/addons` directory, you can restore your add-on data with the [Import development output](development-tools.mdx#import-development-output) command.
...
## Add-on management commands {/* #add-on-management-commands */}
