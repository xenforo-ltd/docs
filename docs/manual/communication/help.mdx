...
Specific information about editing and forcing user-acceptance of *Terms and rules* and *Privacy policy* is available in this manual under the [Terms and rules section](../configuration/terms.mdx).
