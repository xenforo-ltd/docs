...
Specific information about editing and forcing user-acceptance of *Terms and rules* and *Privacy policy* is available in this manual under the [Terms and rules section](../terms-rules/terms.md).
...
The [display order](../common-concepts/display-order.md) value dictates where in the help navigation the page will appear. Pages with higher display order values appear after those with lower display order values.
