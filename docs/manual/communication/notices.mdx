...
The **[display order](../common-concepts/display-order.mdx)** of notices defines their position relative to other notices of the same type. Notices with higher display order values will display before notices with lower display order values.

### Notice criteria {/* #notice-criteria */}
...
For more information about criteria, see the [Criteria](../common-concepts/criteria.mdx) section of this manual.