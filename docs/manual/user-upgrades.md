...
**Any content or feature, access to which can be controlled through [permissions](permissions.md), can be attached to a user upgrade.**
...
* [Creating subscription to a premium content forum](user-upgrade-premium-forum.md) 
* [Paying for access to user profile banners](user-upgrade-profile-banners.md)
