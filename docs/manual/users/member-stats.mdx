...
For example, you may want to show the top posters, or those users with the most accepted [solutions](../forums/types/available/questions.mdx#solutions).
