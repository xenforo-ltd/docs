...
This tool allows you to inspect the inner workings of the [image proxy](../configuration/proxy.md), to ensure that it is able to successfully fetch the requested image and serve it to your visitors.
...
The configuration page for the [XenForo progressive web app](../configuration/pwa.md) also automatically tests and reports the ability of your system to provide the PWA functionality.