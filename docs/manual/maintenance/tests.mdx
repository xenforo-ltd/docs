...
This tool allows you to inspect the inner workings of the [image proxy](../configuration/options-list/proxy.mdx), to ensure that it is able to successfully fetch the requested image and serve it to your visitors.
