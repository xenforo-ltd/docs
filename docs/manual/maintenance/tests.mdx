...
## Test URL unfurling {/* #test-url-unfurling */}
...
## Test outbound email {/* #test-outbound-email */}
...
## Test image proxy {/* #test-image-proxy */}

**Tools > Checks and tests > Test image proxy**

This tool allows you to inspect the inner workings of the [image proxy](../configuration/proxy.mdx), to ensure that it is able to successfully fetch the requested image and serve it to your visitors.

## File health check {/* #file-health-check */}
...
The configuration page for the [XenForo progressive web app](../configuration/pwa.mdx) also automatically tests and reports the ability of your system to provide the PWA functionality.