...
Depending upon how you installed XenForo, config.php may have created by copying the contents of the original `src/config.php.default` file, or the [XenForo installer](install.md) may have created if for you.
...
Defines the format for links using the [Image and link proxy](proxy.md).
