...
The Enhanced Search follows the standard XenForo add-on packaging system and approaches. Full guidance for these actions can be found in the [add-ons section](../configuration/add-ons.md).
...
:::note
Once the index has been created, you must [rebuild the search index](../maintenance/rebuild-caches.md#rebuild-search-index) in the control panel for all existing documents to be found. If you change your index configuration later, you will need to rebuild the search index again.
:::
