...
Links posted in user messages will automatically be processed and turned into embedded media if the **Auto-embed media links** option is enabled under the **Media embedding** section of [XenForo's options system](../configuration/options.mdx).

### BB code media site manager {/* #bb-code-media-site-manager */}
...
### BB code media site editor {/* #bb-code-media-site-editor */}
