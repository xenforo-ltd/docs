...
#### Image replacement URL {/* #image-replacement-url */}
...
#### 2x image replacement URL {/* #2x-image-replacement-url */}
...
#### Smilie category, Display order and Show this smilie in text editor {/* #smilie-category-display-order-and-show-this-smilie-in-text-editor */}
...
Smilies with higher [display order](../common-concepts/display-order.mdx) values are shown after those with low display order values.
