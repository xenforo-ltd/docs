...
### Custom BB code editor {/* #custom-bb-code-editor */}
...
#### Supports option parameter {/* #supports-option-parameter */}
...
You may customize the placement of your custom button (and all other controls) within the XenForo message editor using the [BB code button manager](../appearance/bbcode-button-manager.mdx).

#### Example usage and output {/* #example-usage-and-output */}
...
#### Allow this BB code in signatures {/* #allow-this-bb-code-in-signatures */}
...
##### Option match regular expression {/* #option-match-regular-expression */}
...
##### Within this BB code {/* #within-this-bb-code */}
...
##### Trim line breaks after {/* #trim-line-breaks-after */}
...
##### HTML email and text replacements {/* #html-email-and-text-replacements */}
