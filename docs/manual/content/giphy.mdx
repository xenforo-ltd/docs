...
[giphy-prod-key-1]: /img/manual/GIPHY-prod-key-1.webp
[giphy-prod-key-2]: /img/manual/GIPHY-prod-key-2.webp
...
* Download [this image](/img/manual/GIPHY-prod-key-1.webp) which shows the features of the GIPHY integration.
...
* Download [this image](/img/manual/GIPHY-prod-key-2.webp) which shows the attribution marks.
