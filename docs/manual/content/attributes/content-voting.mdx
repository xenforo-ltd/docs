...
### In conjunction with...
Some content types attribute specific meaning to votes cast against them. Those include answer posts in [question threads](../../forums/types/available/questions.mdx), where the quality of answers can be voted up and down, and votes against [suggestions](../../forums/types/available/suggestions.mdx), where the votes are used to indicate the popularity of or support for the suggestion.
