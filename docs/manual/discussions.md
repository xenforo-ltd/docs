...
Discussions are one of XenForo's [forum and thread types](forum-thread-types.md).
...
Discussion threads may reside in a dedicated [discussion forum](discussions.md#discussion-forums), or a [mixed-type forum](discussions.md#mixed-type-forums) that allows discussion threads.
...
By default, discussion forums contain [discussion](discussions.md#discussion-threads) threads and [poll](discussions.md#poll-threads) threads.
...
A mixed type forum is essentially a regular discussion forum that can also host other thread types. Support for [article](articles.md#article-threads) and [question](questions.md#question-threads) thread types may be added to discussion forums, which turns them into [mixed-type forums](discussions.md#mixed-type-forums).
