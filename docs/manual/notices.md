...
The **[display order](display-order.md)** of notices defines their position relative to other notices of the same type. Notices with higher display order values will display before notices with lower display order values.
...
For more information about criteria, see the [Criteria](criteria.md) section of this manual.