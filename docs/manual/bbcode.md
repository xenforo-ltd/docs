...
You may customize the placement of your custom button (and all other controls) within the XenForo message editor using the [BB code button manager](bbcode-button-manager.md).
