...
Both of these documents are displayed by default among your [Help pages](../communication/help.mdx) and are linked in the footer of your site.
...
You may edit these using the [Phrase editor](../appearance/phrases.mdx#phrase-editor) as with any other phrases in the XenForo system, but for your convenience they may also be edited in the **Commonly edited phrases** section that is available when [editing the settings for a language](../appearance/languages.mdx#language-settings).
...
### Forcing acceptance again {/* #forcing-acceptance-again */}
