...
Both of these documents are displayed by default among your [Help pages](../communication/help.md) and are linked in the footer of your site.
...
You may edit these using the [Phrase editor](../appearance/phrases.md#phrase-editor) as with any other phrases in the XenForo system, but for your convenience they may also be edited in the **Commonly edited phrases** section that is available when [editing the settings for a language](../appearance/languages.md#language-settings).
