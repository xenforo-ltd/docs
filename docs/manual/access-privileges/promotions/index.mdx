...
Once the promotion has been saved, any members active recently, who match all of the criteria, will be promoted [when the promotion job runs](#how-promotions-are-applied).
