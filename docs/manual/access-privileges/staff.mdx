...
### Staff display flag {/* #staff-display-flag */}

When editing a [user's profile](../users/user-profile.mdx#display-user-as-staff), you may set the _Display user as staff_ option. This option will include the specified user in any staff lists you may publish on your forum, such as the _Staff online_ widget, but it does not confer any additional rights, roles or privileges to the user.
