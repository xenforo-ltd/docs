...
* Gears: shortcut to jump to sections of the [Options](configuration/options-list/index.mdx) system
* Magnifier: search the admin control panel - [see below](#searching-the-control-panel).
