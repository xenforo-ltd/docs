...
XenForo 2.0.2 ships with [a new redirection system](notes/import-notes-vbulletin.mdx#xenforo-redirects-for-vbulletin) that aims to take the effort out of setting up redirects. You can read about it here:
