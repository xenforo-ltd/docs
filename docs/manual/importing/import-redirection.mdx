...
### Redirection for vBulletin {/* #redirection-for-vbulletin */}

XenForo 2.0.2 ships with [a new redirection system](import-notes-vbulletin.mdx#xenforo-redirects-for-vbulletin) that aims to take the effort out of setting up redirects. You can read about it here:

[XenForo Redirects for vBulletin](import-notes-vbulletin.mdx#xenforo-redirects-for-vbulletin) 