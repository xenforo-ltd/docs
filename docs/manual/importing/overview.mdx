...
Before you begin an import, there are a number of considerations and preparatory steps you may want to make prior to the configuration process. These steps vary depending on the system from which you will be importing, and are described in the [system-specific importer notes](overview.mdx#system-specific-importer-notes) below.

## Selecting an importer {/* #selecting-an-importer */}
...
## System-specific importer notes {/* #system-specific-importer-notes */}
...
- [vBulletin](import-notes-vbulletin.mdx)
