...
## Selecting import steps {/* #selecting-import-steps */}
...
### Retain content IDs {/* #retain-content-ids */}
...
Don't worry about existing links in search engines etc. pointing to URLs using the old source IDs. Many importers supply [redirection scripts](import-redirection.mdx) that can seamlessly redirect visits to old pages in your source system to their corresponding new pages in XenForo.

### Import log table {/* #import-log-table */}
