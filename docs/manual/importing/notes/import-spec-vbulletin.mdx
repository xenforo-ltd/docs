...
When importing from vBulletin, the XenForo system will require access to the
following data:
...
The following data will be imported, though a new payment profile will need to
be attached.
...
All private messages will be imported into XenForo as separate conversations, as
vBulletin 3.x does not support linked replies.
