...
The next time the *User group promotions* [cron job](cron.md) runs, any users whose birthday is today will be added to the `Birthday today` group and will have *It's my birthday today* as a banner added underneath their name in any messages they have posted.