...
Articles are one of XenForo's [forum and thread types](forum-thread-types.mdx).

### Article threads {/* #article-threads */}
...
#### Expanded display style {/* #expanded-display-style */}
