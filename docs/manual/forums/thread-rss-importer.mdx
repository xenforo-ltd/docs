...
When creating a feed, you must choose the forum into which the thread will be posted, and the user to be attributed as the author of the thread to be created. If you select the guest option, the name associated with the thread will be the author value provided by the feed.
