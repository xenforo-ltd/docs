...
Article threads may be posted within [article forums](#article-forums), or [mixed-type forums](discussions.mdx#mixed-type-forums) in which articles are permitted.
