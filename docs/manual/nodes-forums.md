...
For more details on moderator permissions, see the [moderators](staff.md#moderators) section.
...
Permissions are an intricate subject. For more information, please see the [permissions](permissions.md) section.
...
2. At the top of the page, check the **[Private node](permissions.md#private-nodes)** option and hit the **Save** button below.
...
You may adapt this example to create forums access to which is restricted to other user groups you may create, or even [create forums to which your users may pay to subscribe](user-upgrade-premium-forum.md).  
