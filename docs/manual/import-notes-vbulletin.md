...
Any custom FAQ pages that exist within your vBulletin installation can be imported either as XenForo [_help pages_](help.md), or as [_page nodes_](nodes-forums.md#node-types).
...
To use the system, start by installing the add-on, which can be done from the '[Add-ons](add-ons.md#installing-or-upgrading-an-add-on)' section of your admin control panel.

Next, proceed immediately to the [Options](options.md) section of the control panel, and navigate to the newly-added **vBulletin import** option group.
