...
This is achieved through a system of *[Phrases](phrases.mdx)*, which in turn belong to *[Languages](languages.mdx#languages)*. A single XenForo installation may have multiple languages available, and these can be selected by your visiting users.

## Languages {/* #languages */}

In XenForo, *Languages* function in a similar manner to *[Styles](styles.mdx)*, in that they represent a collection of data that is grouped together for ease of management.

### Pre-built languages {/* #pre-built-languages */}
...
A full description of the way inheritance works can be found in the [styles section of this manual](styles.mdx#style-inheritance).
