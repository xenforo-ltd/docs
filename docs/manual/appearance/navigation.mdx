...
### Editing and adding new items {/* #editing-and-adding-new-items */}
...
#### Parent navigation entry {/* #parent-navigation-entry */}
...
The [display order](../common-concepts/display-order.mdx) is a number of your choice. Items with high display order values will display after items with low display order values when attached to the same parent item.
