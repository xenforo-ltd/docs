...
This is achieved through a system of *[Phrases](phrases.mdx)*, which in turn belong to *[Languages](#languages)*. A single XenForo installation may have multiple languages available, and these can be selected by your visiting users.

## Languages
In XenForo, *Languages* function in a similar manner to *[Styles](../theming/styles.mdx)*, in that they represent a collection of data that is grouped together for ease of management.
...
A full description of the way inheritance works can be found in the [styles section of this manual](../theming/styles.mdx#style-inheritance).
