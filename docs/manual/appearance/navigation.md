...
The [display order](../common-concepts/display-order.md) is a number of your choice. Items with high display order values will display after items with low display order values when attached to the same parent item.
