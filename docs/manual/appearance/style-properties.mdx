...
### More advanced properties {/* #more-advanced-properties */}

From the style property manager, open the *Header and navigation* group.

Here, you will find style properties that control the appearance of the top of all your XenForo pages, including the header and the [public navigation](navigation.mdx#public-navigation).
