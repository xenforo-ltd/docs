...
This can be useful when used in conjunction with a [paid user upgrade](../users/paid-upgrades/index.mdx) in which users may pay to view a version of your site with all ads hidden.
...
## Advert positions
The XenForo [templates](theming/templates.mdx) are preconfigured with numerous locations in which ads can be placed with minimal effort. Within the template code, these appear as follows:
