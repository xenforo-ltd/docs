...
This can be useful when used in conjunction with a [paid user upgrade](../users/user-upgrades.md) in which users may pay to view a version of your site with all ads hidden.

### Display order

If you have multiple ads deployed to the same position, they will be displayed according to the [display order](../common-concepts/display-order.md) that you define.
