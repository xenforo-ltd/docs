...
During an upgrade, no customized templates will be overwritten, so you should check to ensure that your customizations are both compatible with the new version of XenForo, and also support any and all new functionality. A detailed discussion of this can be found in the [upgrade section of the manual](upgrade.md#upgrading-with-customized-templates).
