...
The linked images can either be loaded directly by users viewing the content in which the images are embedded, or you may choose to have your server proxy the images using the [image and link proxy](proxy.md).
