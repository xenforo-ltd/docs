...
### Configuring friendly URLs {/* #configuring-friendly-urls */}
...
### Friendly URL web server requirements and setup {/* #friendly-url-web-server-requirements-and-setup */}
...
LiteSpeed Web Server reads and uses Apache configurations (including .htaccess files) and will work using [the above Apache documentation](friendly-urls.mdx#apache).
