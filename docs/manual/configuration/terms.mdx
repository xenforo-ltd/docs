...
You may edit these using the [Phrase editor](../appearance/ui-text/phrases.mdx#phrase-editor) as with any other phrases in the XenForo system, but for your convenience they may also be edited in the **Commonly edited phrases** section that is available when [editing the settings for a language](../appearance/ui-text/languages.mdx#language-settings).
