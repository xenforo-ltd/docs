...
### Configuring the Spam cleaner {/* #configuring-the-spam-cleaner */}

1. Log in to the Admin control panel.
1. Click on [Options](../options.mdx) from the *Setup* section of the navigation panel.
...
### Using the Spam cleaner {/* #using-the-spam-cleaner */}

To use the spam cleaner, a user must have the appropriate spam cleaner permission enabled. This can be done by way of user group or user permissions, as explained in detail in the [Permissions](../../access-privileges/permissions.mdx) section of this manual.
...
:::note
Banned users do not automatically show as being banned nor do they have any specific markup applied to their user name or title. Refer to the [Discouraging](../../users/discouragement.mdx) and [Banning](../../users/banning.mdx) section for further information.
:::

#### Restoring deleted content {/* #restoring-deleted-content */}
