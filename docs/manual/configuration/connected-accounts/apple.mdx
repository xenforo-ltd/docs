...
### Configuring Sign In with Apple connected account {/* #configuring-sign-in-with-apple-connected-account */}
...
8. [Test the connected account](index.mdx#testing-connected-accounts)

### Configuring Email for Apple Private Relay support {/* #configuring-email-for-apple-private-relay-support */}
