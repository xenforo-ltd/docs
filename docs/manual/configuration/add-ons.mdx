...
## Installing or upgrading an add-on {/* #installing-or-upgrading-an-add-on */}

### Control panel installation (2.1+) {/* #control-panel-installation-21 */}
...
## Disabling an add-on {/* #disabling-an-add-on */}
...
## Uninstalling an add-on {/* #uninstalling-an-add-on */}
...
## Regaining control panel access {/* #regaining-control-panel-access */}
