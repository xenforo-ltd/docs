...
To change this, you must first identify the route of the page you want to set as the index. This is discussed in the [Route filters](route-filters.mdx) section. Here are a few examples:
