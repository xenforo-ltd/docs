...
### Upgrading from XenForo 1 {/* #upgrading-from-xenforo-1 */}
...
### One-click upgrades {/* #one-click-upgrades */}
...
When you customize a [template](../appearance/templates.mdx), the changes are saved and will not be overwritten unless you specifically instruct the system to do so.
...
#### Outdated templates {/* #outdated-templates */}
...
### Common upgrading problems {/* #common-upgrading-problems */}

#### Attempting a fresh install instead of an upgrade {/* #attempting-a-fresh-install-instead-of-an-upgrade */}
...
#### No upgrade found {/* #no-upgrade-found */}
