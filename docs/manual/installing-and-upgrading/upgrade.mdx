...
When you customize a [template](../appearance/theming/templates.mdx), the changes are saved and will not be overwritten unless you specifically instruct the system to do so.
