...
## Installing XenForo for the first time {/* #installing-xenforo-for-the-first-time */}
...
:::
    ...
    If you are trying to upgrade your existing XenForo installation to a new version, you need to [upgrade](upgrade.mdx), not install.
