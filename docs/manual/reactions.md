...
The first part is specific to reactions, and provides input fields to define the title, text color, reaction score and [display order](display-order.md) for the currently-edited reaction.
