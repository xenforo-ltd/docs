...
A user can be discouraged by editing the user in the control panel and enabling the *Discouraged* option. The behavior of the discouragement system can be controlled by [options](options.md) in the *User discouragement and discipline* group.
