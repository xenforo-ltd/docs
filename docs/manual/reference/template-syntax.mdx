...
### Extension parent {/* #extension-parent */}
...
### Calling a macro {/* #calling-a-macro */}
...
## UI component tags {/* #ui-component-tags */}
...
### Common row attributes {/* #common-row-attributes */}
...
### Password box row {/* #password-box-row */}
...
### Date-time input row {/* #date-time-input-row */}
...
### Code editor row {/* #code-editor-row */}
...
### Token input row {/* #token-input-row */}
...
### Telephone box row {/* #telephone-box-row */}
...
### Prefix input row {/* #prefix-input-row */}
...
### Asset upload row {/* #asset-upload-row */}
...
### URL and linking {/* #url-and-linking */}
