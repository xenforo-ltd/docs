...
This is a reference for the XenForo template syntax. For a practical guide to using templates in add-on development, see [Template basics](../../devs/template-basics.mdx).
